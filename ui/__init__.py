...
__all__ = [
    ...
    "IndexOcrDialog",
    "IndexBatchLogDialog",
    "IndexDragFieldsWindow",
    "IndexReorderPagesWindow",
    "QcCommentDialog",
...
_LAZY: dict[str, tuple[str, str]] = {
    ...
    "IndexBatchLogDialog": (".index_batch_log_dialog", "IndexBatchLogDialog"),
    "IndexDragFieldsWindow": (".index_drag_fields_window", "IndexDragFieldsWindow"),
    "IndexReorderPagesWindow": (".index_reorder_pages_window", "IndexReorderPagesWindow"),
